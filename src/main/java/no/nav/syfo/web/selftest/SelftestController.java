...
public class SelftestController {
    ...
    @ResponseBody
    @RequestMapping(value = "/testEndepunkt/{geografiskTilknytning}/{tema}/{behandlingstema}", produces = MediaType.APPLICATION_JSON_VALUE)
    public List<String> testEndepunkt(@PathVariable String geografiskTilknytning, @PathVariable String tema, @PathVariable String behandlingstema) {
        return behandlendeEnhetConsumer.finnBehandlendeEnhetListe(geografiskTilknytning, tema, behandlingstema);
    }
