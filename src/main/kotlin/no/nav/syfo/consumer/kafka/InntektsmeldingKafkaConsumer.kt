...
import no.nav.syfo.utsattoppgave.KafkaErrorHandler
...
class UtsattOppgaveConsumer() {
    ...
    fun listen(cr: ConsumerRecord<String, JoarkEventDTO>, acknowledgment: Acknowledgment) {
...
class UtsattOppgaveConsumerConfig(
    ...
    fun consumerProperties(): Map<String, Any> = mapOf(
        ...
        ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG to JoarkEventDTODeserializer::class.java,
    ...
    class JoarkEventDTODeserializer : Deserializer<JoarkEventDTO> {
        override fun deserialize(topic: String, data: ByteArray): JoarkEventDTO {
