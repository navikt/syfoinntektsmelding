...
class InntektsmeldingMapper {
    ...
    fun mapInntektsmelding(inntektsmeldingRAW: ByteArray, aktørId: String, mottattDato: LocalDateTime, journalpostId: String, journalStatus: JournalStatus, arkivReferanse: String): Inntektsmelding {
        ...
        return if (jaxbInntektsmelding.value is XMLInntektsmeldingM)
            ...
            InntektsmeldingArbeidsgiverPrivat20181211Mapper.tilXMLInntektsmelding(jaxbInntektsmelding, journalpostId, mottattDato, journalStatus, aktørId, arkivReferanse)
        }
    }
