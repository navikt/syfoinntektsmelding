...
fun preprodConfig(config: ApplicationConfig) = module {
    ...
    single { DatapakkePublisherJob(get(), get(StringQualifier("datapakkeHttpClient")), config.getString("datapakke.api_url"), config.getString("datapakke.id"), logDatapakke = true) }
