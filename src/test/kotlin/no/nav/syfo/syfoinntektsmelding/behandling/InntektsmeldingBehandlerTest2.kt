...
class InntektsmeldingBehandlerTest2 {
    ...
    private var journalV2 = mockk<SafDokumentClient>(relaxed = true)
    ...
    fun setup() {
        ...
        journalConsumer = JournalConsumer(journalV2, safJournalpostClient, aktorConsumer)
...
//        every {
//            runBlocking {
//                journalV2.hentDokument(any(), any())
//            }
//        } returnsMany listOf(
