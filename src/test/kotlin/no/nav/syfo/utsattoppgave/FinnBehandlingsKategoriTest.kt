...
internal class FinnBehandlingsKategoriTest {
    ...
    fun bestrider_sykemelding() {
        val inntektsmelding =
            mockInntektsmelding(
                Refusjon(beloepPrMnd = BigDecimal(17000), null),
                BigDecimal(17000),
            ).copy(begrunnelseRedusert = "BetvilerArbeidsufoerhet")
        assertEquals(
    ...
    fun speil_relatert() {
        ...
        assertEquals(
            ...
            finnBehandlingsKategori(inntektsmelding = inntektsmelding, speilRelatert = true, gjelderUtland = false),
        )
        assertEquals(
            BehandlingsKategori.SPEIL_RELATERT,
            finnBehandlingsKategori(inntektsmelding = inntektsmelding, speilRelatert = true, gjelderUtland = true),
        )
    }
    ...
    fun gjelder_utland() {
        ...
        assertEquals(
            ...
            finnBehandlingsKategori(inntektsmelding = inntektsmelding, speilRelatert = false, gjelderUtland = true),
        )
    }
    ...
    fun ikke_fravaer() {
        val inntektsmelding =
            mockInntektsmelding(
                Refusjon(beloepPrMnd = BigDecimal(17000), null),
                BigDecimal(17000),
            ).copy(begrunnelseRedusert = "IkkeFravaer")
        assertEquals(
            BehandlingsKategori.IKKE_FRAVAER,
            finnBehandlingsKategori(inntektsmelding = inntektsmelding, speilRelatert = false, gjelderUtland = false),
        )
    }
