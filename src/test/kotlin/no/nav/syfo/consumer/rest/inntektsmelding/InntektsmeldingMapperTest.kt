...
class InntektsmeldingMapperTest {
    ...
    fun map20180924() {
        ...
        val im = InntektsmeldingMapper().mapInntektsmelding(bytes, AKTØR_ID, MOTTATT_DATO, JOURNALPOST_ID, JournalStatus.MIDLERTIDIG, ARKIV_REFERANSE  )
