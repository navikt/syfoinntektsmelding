...
public class EksisterendeSakConsumerTest {
    ...
    @Test
    public void test() {
        when(restTemplate.exchange(anyString(), any(HttpMethod.class), any(HttpEntity.class), (Class<NyesteSakResponse>) any())).thenReturn(new ResponseEntity<>(new NyesteSakResponse("saksId"), HttpStatus.OK));
